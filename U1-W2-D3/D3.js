...
/* ESERCIZIO 2
  ...
  Dovrai accedere alla proprietà "name" di ogni oggetto in esso contenuto, e inserirla nell'array "charactersNames" 
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  const occhi = starWarsCharacters[i].eye_color;

  switch (occhi) {
    case "blue":
      eyeColor.blue.push(starWarsCharacters[i].name);
      console.log("occhi blu:", starWarsCharacters[i].name);
      break;
    case "yellow":
      eyeColor.yellow.push(starWarsCharacters[i].name);
      console.log("occhi gialli:", starWarsCharacters[i].name);
      break;
    case "brown":
      eyeColor.brown.push(starWarsCharacters[i].name);
      console.log("occhi marroni:", starWarsCharacters[i].name);
      break;
    case "red":
      eyeColor.red.push(starWarsCharacters[i].name);
      console.log("occhi rossi:", starWarsCharacters[i].name);
      break;
    case "blue-gray":
    case "blueGray":
      eyeColor.blueGray.push(starWarsCharacters[i].name);
      console.log("occhi grigio-blu:", starWarsCharacters[i].name);
      break;
    default:
      console.log("colore occhi non definito:", starWarsCharacters[i].name);
  }
}
